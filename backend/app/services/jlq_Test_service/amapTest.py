...
from backend.app.models.schemas import Location, POIInfo, WeatherInfo
...
amap_service_test = AmapService()
print(f"对poi函数进行测试.....{amap_service_test.search_poi("景点","广州","True")}")